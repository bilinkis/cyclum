...
@section('content')
    ...
    <footer class="page-footer">
        <div class="footer-row container">
            <div class="row">
                <div class="col l6 s12">
                    <h5 class="white-text">Acerca de Cyclum</h5>
                    <p class="grey-text text-lighten-4">Cyclum se puede lograr solo con sangre, sudor y lagrimas asi que los obligamos a donarnos $1.000.000 de dolares. Gracias por colaborar.</p>
                </div>
                <div class="col l4 offset-l2 s12">
                    <h5 class="white-text">Contacto</h5>
                    <ul>
                        <li><a class="grey-text text-lighten-3" target="_blank" href="http://www.twitter.com/Cyclum.IO">Twitter</a></li>
                        <li><a class="grey-text text-lighten-3" target="_blank" href="http://www.facebook.com/Cyclum.IO">Facebook</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="footer-copyright">
            <div class="container">
                © 2016 Brand New Paraguas Inc.<a class="grey-text text-lighten-4 right scroll-animation" href="#nav-bar">Volver a arriba</a>
            </div>
        </div>
    </footer>
